...
__DEFINE__(1642921271001, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1642921271002,"./event-store":1642921271003}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642921271002, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1642921271003, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1642921271002,"./utils":1642921271004}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1642921271004, function(require, module, exports) {
...
return __REQUIRE__(1642921271001);
})()
